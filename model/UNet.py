...
What to modify:
    1. input channel --> how to represent the pose
    2. output, pixel confidence added
    3. teh interface for pose score
"""
import torch
...
class UNet(nn.Module):
    def __init__(self, in_dim = 4, out_dim = 3 ,useBN=False):
        super(UNet, self).__init__()

        self.conv1 = add_conv_stage(in_dim, 32, useBN=useBN)
