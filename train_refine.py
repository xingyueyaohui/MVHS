...
def run():
    ...
    lr_generator = 2.5 * 1e-4
    lr_discriminator = 2.5 * 1e-4
    session = 4
    lam = 40

    generator = Generator(64, 6).cuda()
    generator.load_state_dict(torch.load('/home/dongkai/pzq/MVHS/base_model/G.pkl'))
    discriminator = Discriminator(128, 64).cuda()
    discriminator.load_state_dict(torch.load('/home/dongkai/pzq/MVHS/base_model/D.pkl'))
    ...
    dataset = pickle.load(open('/home/dongkai/pzq/data/pose/dataset.pkl', 'rb'))
    src_dir = '/home/dongkai/pzq/data/market-gt/'
    pose_map_dir = '/home/dongkai/pzq/data/market-pose-map/'
    tgt_mask_dir = '/home/dongkai/pzq/data/market-mask/'
    warp_dir = '/home/dongkai/pzq/data/market-morph/'
    match_path = '/home/dongkai/pzq/data/pose/match.json'
    match_file = open(match_path, 'r')
    data_json_path = '/home/dongkai/pzq/data/pose/market-pose.json'
    ...
    instance_num = 2   # 2 people warping for one id
    ...
    for epo in range(epoch):
        ...
        if (epo + 1) % 5 == 0:
            torch.save(generator.state_dict(), '/home/dongkai/pzq/MVHS/pretrain/PNG_6_s{s}e{epo}.pkl'.format(s=session,epo=epo))
            torch.save(discriminator.state_dict(), '/home/dongkai/pzq/MVHS/pretrain/D_6_s{s}e{epo}.pkl'.format(s=session,epo=epo))
...
def out_model():
    ...
    generator = Generator(64, 6).cuda()
    generator.load_state_dict(torch.load('/home/dongkai/pzq/MVHS/pretrain/PNG_6_s4e4.pkl'))
    ...
    # Output the results
    out_dir = '/home/dongkai/pzq/MVHS/vis_data/'
