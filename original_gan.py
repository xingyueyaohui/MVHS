...
def run():
    ...
    generator.load_state_dict(torch.load('/home/pzq/pose_warp/trained_model/PNG6_Gbase.pkl'))
    discriminator = Discriminator(128, 64).cuda()
    discriminator.load_state_dict(torch.load('/home/pzq/pose_warp/trained_model/PNG6_Dbase.pkl'))
...
def out_model():
    ...
    # generator = UNet(useBN=True).cuda()
    generator = Generator(64, 6).cuda()
    generator.load_state_dict(torch.load('/home/pzq/pose_warp/pretrain/PNG_s2e9.pkl'))
